...
public class SpecificationcategoryConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String submittedValue) {
        if (submittedValue.trim().isEmpty()) {
            ...
            try {
                ...
                Specificationcategory specificationcategory = persistenceHelper.getEntityManager().find(Specificationcategory.class, number);
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object value) {
        try {
            if (value == null || value.equals("")) {
                ...
                return String.valueOf(((Specificationcategory) value).getSpecificationcategoryid());
            }
        } catch (Exception e) {
            e.printStackTrace();
            return "";
