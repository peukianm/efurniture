...
public class ProductLineConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String submittedValue) {
        if (submittedValue.trim().isEmpty()) {
            ...
            try {
                ...
                Productline productline = persistenceHelper.getEntityManager().find(Productline.class, number);
                return productline;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object value) {
        try {
            if (value == null || value.equals("")) {
                ...
                return String.valueOf(((Productline) value).getProductlineid());
            }
        } catch (Exception e) {
            e.printStackTrace();
            return "";
